...
public:
#define CIR_ADD1(num, inc) Util::circulative_add(num, inc)
#define CIR_ADD2(num1, num2) Util::circulative_add(num1, num2)
    static void circulative_add(uint32_t* num, uint32_t increment);
    static uint32_t circulative_add(uint32_t num1, uint32_t num2);
};
